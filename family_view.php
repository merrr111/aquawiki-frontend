...
// ✅ Fetch fishes belonging to this family
$stmt = $conn->prepare("SELECT * FROM fishes WHERE LOWER(family) = LOWER(?)");
...
<div class="hero">
  ...
  <div class="hero-content">
    <h1><?php echo htmlspecialchars($family); ?> Family</h1>
    <p>Explore all freshwater fishes belonging to the <strong><?php echo htmlspecialchars($family); ?></strong> family.</p>
  </div>
</div>

<!-- SPECIES COUNT -->
<div class="species-count">
  <?php echo $totalFishes; ?> species in this family.
</div>
...
<div class="fish-grid">
  <?php if ($totalFishes > 0): ?>
    ...
    <?php endwhile; ?>
  <?php else: ?>
    <p style="grid-column:1/-1;text-align:center;color:#ccc;">No fishes found in this family.</p>
  <?php endif; ?>
</div>
